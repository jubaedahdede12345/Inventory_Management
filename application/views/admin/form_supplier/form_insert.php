...
<head>
  ...
  <title>Web Gudang | Data Supplier</title>
...
<div class="wrapper">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_supplier_masuk_insert')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="id_supplier" style="margin-left:220px;display:inline;">ID Supplier</label>
                  <input type="text" name="id_supplier" style="margin-left:37px;width:20%;display:inline;" class="form-control" value="">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="nama_supplier" style="width:87%;margin-left: 12px;">Nama Supplier</label>
                  <input type="text" name="nama_supplier" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="nama_supplier" placeholder="Nama Supplier">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="alamat_supplier" style="width:73%;">Alamat Supplier</label>
                  <input type="text" name="alamat_supplier" style="width:90%;margin-right: 67px;" class="form-control" id="alamat_supplier" placeholder="Alamat Supplier">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="telepon_supplier" style="width:73%;">Telepon Supplier</label>
                  <input type="text" name="telepon_supplier" style="width:90%;margin-right: 67px;" class="form-control" id="telepon_supplier" placeholder="Telepon Supplier">
                </div>
  ...
  <!-- Letakkan di dalam tag <head> atau sebelum penutup tag </body> -->
  <script>
      document.addEventListener("DOMContentLoaded", function () {
          ...
          if (supplierForm) {
              supplierForm.addEventListener("submit", function (event) {
                  event.preventDefault(); // Mencegah aksi default (refresh halaman)

                  // Lakukan pengiriman data form atau interaksi lain yang Anda inginkan di sini
                  // Contoh: Kirim data menggunakan AJAX, validasi form, dll.
              });
          }
      });
  </script>
