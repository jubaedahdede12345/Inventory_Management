...
<head>
  ...
  <title>Web Inventory | Edit Stock Barang</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tabel Stock Barang</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Data Stock Barang</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
                  ...
                  <?php foreach($data_satuan as $d){ ?>
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        ...
                        <label for="id_barang" style="width:87%;margin-left: 12px;">Id Barang</label>
                        <input type="text" required name="id_barang" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="id_barang" placeholder="Id Barang" value="<?=$d->id_barang?>">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_barang" style="width:73%;">Nama Barang</label>
                        <input type="text" required name="nama_barang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_barang" placeholder="Nama Barang" value="<?=$d->nama_barang?>">
                    </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="stock_barang" style="width:73%;">Stock Barang</label>
                        <input type="text" required name="stock_barang" style="width:90%;margin-right: 67px;" class="form-control" id="stock_barang" placeholder="Stock Barang" value="<?=$d->stock_barang?>">
                    </div>
                    <div class="form-group" style="display:inline-block;">
