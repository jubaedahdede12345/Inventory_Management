...
<head>
  ...
  <title>Web Inventory | Dashboard</title>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>assets/web_admin/dist/css/skins/_all-skins.min.css">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('admin/form_barangmasuk') ?>"><i class="fa fa-circle-o"></i> Tambah Data
                  Barang Masuk</a></li>
              <li><a href="<?php echo base_url('admin/form_satuan') ?>"><i class="fa fa-circle-o"></i> Tambah Data Stock
                  Barang</a></li>
            </ul>
          </li>
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url('admin/tabel_supplier') ?>"><i class="fa fa-circle-o"></i> Tabel Supplier</a>
              </li>
              ...
              <li><a href="<?= base_url('admin/tabel_barangkeluar') ?>"><i class="fa fa-circle-o"></i> Tabel Barang
                  Keluar</a></li>
              <li><a href="<?= base_url('admin/tabel_satuan') ?>"><i class="fa fa-circle-o"></i> Tabel Stock Barang</a>
              </li>
            </ul>
